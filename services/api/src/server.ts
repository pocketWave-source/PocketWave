...
import type { ClientSettings, TranslationMode } from "./types";
...
const MAX_PRODUCER_SESSION_MS = config.maxProducerSessionMs;
const PRODUCER_IDLE_TIMEOUT_MS = config.producerIdleTimeoutMs;
const PAIRING_TTL_MS = config.pairingTtlMs;
